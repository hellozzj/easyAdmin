...
class Utils {
    ...
    public static function pagerLimit($limit_arr) {
        ...
        $html .= '<option value="-1">所有</option> </select>&nbsp;行</label>';
        $html .= '</div> </div> <div class="col-sm-6"> <div id="example1_filter" class="dataTables_filter"> <label>搜索表格:<input id="ipt_search_table" type="search" class="form-control input-sm" placeholder="" aria-controls="example1"></label> </div> </div> </div>';
