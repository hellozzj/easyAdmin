...
use app\lib\action; 
use app\lib\utils; 
use app\lib\exception\pageexception;
...
class Page extends Action {
    ...
    // 分页显示数量
    protected $limit_arr = array(10, 30, 50, 100);

    public $limit = 30, $page = 0;
    ...
    protected function create_pager($total_record) {
        if (! $total_record)
            return;
        return Utils::pager($total_record, $this->page, $this->limit);
    }

    protected function create_pager_limit() {
        return Utils::pagerLimit($this->limit_arr);
    }
